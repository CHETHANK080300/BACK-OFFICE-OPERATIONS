...
function LoginScreen() {
  ...
  const [email, setEmail] = useState("admin@i-exceed.com");
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-border bg-card p-8 shadow-elevated">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in to your Appzillon admin dashboard
          </p>
        </div>
          ...
          <div className="space-y-4 rounded-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-input bg-muted/40 py-3 pl-10 pr-3 text-sm text-foreground outline-none focus:border-primary transition-all"
